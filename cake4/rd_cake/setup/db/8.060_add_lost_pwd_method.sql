...
if exists (select * from information_schema.columns
    where column_name = 'ctc_require_phone' and table_name = 'dynamic_details' and table_schema = DATABASE()) then
...
if not exists (select * from information_schema.columns
    where column_name = 'lost_password_method' and table_name = 'dynamic_details' and table_schema = DATABASE()) then
