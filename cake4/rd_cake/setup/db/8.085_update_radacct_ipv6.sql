...
if not exists (select * from information_schema.columns
    where column_name = 'framedipv6address' and table_name = 'radacct' and table_schema = DATABASE()) then
...
if not exists (select * from information_schema.columns
    where column_name = 'framedipv6prefix' and table_name = 'radacct' and table_schema = DATABASE()) then
...
if not exists (select * from information_schema.columns
    where column_name = 'framedinterfaceid' and table_name = 'radacct' and table_schema = DATABASE()) then
...
if not exists (select * from information_schema.columns
    where column_name = 'delegatedipv6prefix' and table_name = 'radacct' and table_schema = DATABASE()) then
