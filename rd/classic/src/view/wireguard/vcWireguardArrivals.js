Ext.define('Rd.view.wireguard.vcWireguardArrivals', {
    extend  : 'Ext.app.ViewController',
    alias   : 'controller.vcWireguardArrivals',
    init    : function() {
    
    },
    config: {
        urlAdd      : '/cake4/rd_cake/wireguard-servers/add.json',
        urlDelete   : '/cake4/rd_cake/wireguard-arrivals/delete.json'
    },
    control: {
        'gridWireguardArrivals #reload': {
            click   : 'reload'
        },
        'gridWireguardArrivals #reload menuitem[group=refresh]'   : {
            click   : 'reloadOptionClick'
        },
        'gridWireguardArrivals #attach': {
            click   : 'attach'
        },       
        'gridWireguardArrivals #delete': {
            click   : 'del'
        },    
        'gridWireguardArrivals actioncolumn': { 
        ...
        if(selCount == 0){
            ...
            if(selCount > 1){
                ...
                if(!Ext.WindowManager.get('winWireguardServerAddId')){
                    var w = Ext.widget('winWireguardServerAdd',{
                        id      : 'winWireguardServerAddId',
                        sr      : sr,
                        title   : 'Attach Wireguard Server',
