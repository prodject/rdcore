Ext.define('Rd.controller.cAccessPointEdits', {
    ...
    config      : {  
        urlAddEntry:        '/cake4/rd_cake/ap-profiles/ap_profile_entry_add.json',
        urlViewEntry:       '/cake4/rd_cake/ap-profiles/ap_profile_entry_view.json',
        urlEditEntry:       '/cake4/rd_cake/ap-profiles/ap_profile_entry_edit.json',
        
       
        urlExitAddDefaults: '/cake4/rd_cake/ap-profiles/ap_profile_exit_add_defaults.json',
        urlAddExit:         '/cake4/rd_cake/ap-profiles/ap_profile_exit_add.json',
        urlEditExit:        '/cake4/rd_cake/ap-profiles/ap_profile_exit_edit.json',
         
        urlViewApCommonSettings:'/cake4/rd_cake/ap-profiles/ap_common_settings_view.json',
        urlEditApCommonSettings:'/cake4/rd_cake/ap-profiles/ap_common_settings_edit.json',    
		...
		urlViewApProfileSettings    : '/cake4/rd_cake/ap-profiles/ap-profile-settings-view.json',
